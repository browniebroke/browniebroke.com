...
header_image: _chakra-ui-to-tailwind.png
tags:
  - chakra-ui
  - tailwind
  - cursor
...
I wrote before how [I migrated to ChakraUI](/blog/migrate-my-site-design-system-to-chakra-ui-with-chatgpt/) using ChatGPT to guide me and how that sped up the task. Less than a year later, I migrated again my style system but this time it was even more impressive, and even faster.

## The migration

Having heard about [Cursor](https://www.cursor.com/) a lot lately, and having seen it in action with some colleagues at work, I decided to give it a proper go and was really impressed. I opened the "composer" tool in "agent" mode, opened my codebase and asked to "Replace ChakraUI by Tailwind CSS with the minimum amount of visual differences possible".
