...
import { Kbd, OrderedList, ListItem } from '@chakra-ui/react'
...
<OrderedList>
  <ListItem>
    <Kbd>⌘</Kbd> + <Kbd>⌥</Kbd> + <Kbd>⇧</Kbd> + <Kbd>/</Kbd> to open the
    maintenance context menu
  </ListItem>
  <ListItem>Choose the first option, "Registry..." from it</ListItem>
</OrderedList>
