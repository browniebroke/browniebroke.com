...
1. <kbd className="px-2 py-1 text-sm font-mono bg-gray-100 border border-gray-300 rounded">⌘</kbd> + <kbd className="px-2 py-1 text-sm font-mono bg-gray-100 border border-gray-300 rounded">⌥</kbd> + <kbd className="px-2 py-1 text-sm font-mono bg-gray-100 border border-gray-300 rounded">⇧</kbd> + <kbd className="px-2 py-1 text-sm font-mono bg-gray-100 border border-gray-300 rounded">/</kbd> to open the
