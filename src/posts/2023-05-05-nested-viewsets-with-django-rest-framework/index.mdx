...
<div className="flex items-start p-4 rounded-md bg-blue-50 border-l-4 border-blue-500">
  ...
  <div className="ml-3">
    ...
    <div className="mt-2 text-sm text-blue-700">
      ...
      writing it, I found a much more elegant solution, which turned into a
      loger form post. The first solution was the TIL.
    </div>
  </div>
</div>
